...
// args: inputFile, nThreads,
//  -- inputFile: the original input file to check longest sub sequence palindrome. Default: "input/big.txt"
//  -- nThreads: number of threads used. default value: 1
