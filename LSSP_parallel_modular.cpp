...
void fillTableThread(DPTable* T, uint startCol, uint endCol, int threadCount, int threadId) {
...
void fillTableParallel(DPTable* T, uint nThreads) {
    ...
    for (uint i = 0; i < nThreads; i++) {
        ...
        threads.emplace_back(fillTableThread, T, startCol, endCol, nThreads, i);
    }
